...
RASTERTOBECLIPPED = 'S:/STDV_5_mosaic/STDV_5.tif'
CLIPPED_RASTERS = 'T:/Split_raster/STDV5/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'S:/STDV_5_mosaic/STDV_5.tif' #Raster mosaic to be clipped
