...
RASTERTOBECLIPPED = 'S:/DTW_05ha_mosaic/DTW_05ha.tif'
CLIPPED_RASTERS = 'T:/Split_raster/DTW05ha/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'S:/DTW_05ha_mosaic/DTW_05ha.tif' #Raster mosaic to be clipped
