...
#Inut files
file_directory = 'D:/MLWAM_Production/Rasters/Original/clippedSoilDepth10m'
#output files of subprocess
outputdirectory = 'D:/MLWAM_Production/Rasters/clipped/SoilDepth'
...
for f1 in infiles:
    if f1.endswith('.tif') and f1 not in outfiles:
        ...
        worker = workerThread(f1, 'Slave_ResampleSoil.py').start()
