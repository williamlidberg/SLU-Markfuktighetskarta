...
RASTERTOBECLIPPED = 'S:/SMHI_Autum/Autum.tif'
CLIPPED_RASTERS = 'T:/Split_raster/Autum/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'S:/SMHI_Autum/Autum.tif' #Raster mosaic to be clipped
