...
RASTERTOBECLIPPED = 'D:/MLWAM_Production/Rasters/Original/Y__Coordinates/Y.vrt'
CLIPPED_RASTERS = 'D:/MLWAM_Production/Rasters/clipped/Y_Coordinates/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/MLWAM_Production/Rasters/Original/Y__Coordinates/Y.vrt' #Raster mosaic to be clipped
