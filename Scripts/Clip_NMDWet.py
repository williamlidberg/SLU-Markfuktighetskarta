...
RASTERTOBECLIPPED = 'F:/temp/ResampleNMDWet/NMDWet.vrt'
CLIPPED_RASTERS = 'D:/MLWAM_Production/Rasters/clipped/NMDwet/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'F:/temp/ResampleNMDWet/NMDWet.vrt' #Raster mosaic to be clipped
