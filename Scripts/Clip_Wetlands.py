...
RASTERTOBECLIPPED = 'D:/MLWAM_Production/Convet_shape_to_raster/wetlands/mosaic/Wet.tif'
CLIPPED_RASTERS = 'D:/MLWAM_Production/Rasters/clipped/Wetlands/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/MLWAM_Production/Convet_shape_to_raster/wetlands/mosaic/Wet.tif' #Raster mosaic to be clipped
