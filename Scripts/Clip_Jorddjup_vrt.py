...
RASTERTOBECLIPPED = 'S:/Jorddjup/splitjorddjup2m/jorddjup.vrt'
CLIPPED_RASTERS = 'T:/Split_raster/Jorddjup/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'S:/Jorddjup/splitjorddjup2m/jorddjup.vrt' #Raster mosaic to be clipped
