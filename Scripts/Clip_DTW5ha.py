...
RASTERTOBECLIPPED = 'D:/MLWAM_Production/Rasters/Original/DTW_5ha_mosaic/DTW_5ha.tif'
CLIPPED_RASTERS = 'D:/MLWAM_Production/Rasters/clipped/DTW5ha/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/MLWAM_Production/Rasters/Original/DTW_5ha_mosaic/DTW_5ha.tif' #Raster mosaic to be clipped
