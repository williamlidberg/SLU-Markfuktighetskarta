...
RASTERTOBECLIPPED = 'D:/MLWAM_Production/Rasters/Original/SoilDepth/soildepth32bit10m.tif'
CLIPPED_RASTERS = 'D:/MLWAM_Production/Rasters/Original/clippedSoilDepth10m/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/MLWAM_Production/Rasters/Original/SoilDepth/soildepth32bit10m.tif' #Raster mosaic to be clipped
