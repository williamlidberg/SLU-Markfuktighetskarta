...
arcpy.env.workspace = r"F:\MLWAM_Production\PredictedTwoClassedProbability"
workspace = r"F:\MLWAM_Production\PredictedTwoClassedProbability"
...
print('')
print(ras_list)
MosaicToNewRaster(rasters, r'E:\ProbabilityMosaic', 'Probability.tif', '', '8_BIT_SIGNED', 2, 1, 'LAST')
