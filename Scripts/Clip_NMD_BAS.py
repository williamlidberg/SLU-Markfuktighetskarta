...
RASTERTOBECLIPPED = 'D:/MLWAM_Production/Rasters/Original/NMDBAS/NMD2mNearest.tif'
CLIPPED_RASTERS = 'D:/MLWAM_Production/Rasters/clipped/NMDBAS/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/MLWAM_Production/Rasters/Original/NMDBAS/NMD2mNearest.tif' #Raster mosaic to be clipped
